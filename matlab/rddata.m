...
%------ SPECIFY DATA ------------------------------------------------------
PATH= 'C:\Users\£ukasz\Downloads';%\projekt\New Folder\projekt\src\signals'; % path, where data are saved
HEADERFILE= 'e0116.hea';      % header-file in text format
ATRFILE= 'e0116.atr';         % attributes-file in binary format
DATAFILE='e0116.dat';         % data-file
SAMPLES2READ=1800000;         % number of samples to be read
